    ...
    <div className="flex flex-col min-h-dvh bg-white">
      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="text-center max-w-2xl">
          <div className="mb-8">
            <h1 className="text-6xl sm:text-7xl md:text-8xl font-bold text-[#4db8b8] mb-4">
              404
            </h1>
            ...
            <p className="text-gray-600 text-base sm:text-lg md:text-xl mb-8">
              {t('errors.notFoundDescription') || 'К сожалению, страница которую вы ищете, не существует или была удалена.'}
            </p>
          </div>
