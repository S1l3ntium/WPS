        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              <div className="w-12 h-12 bg-[#4db8b8] rounded-lg flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                </svg>
              </div>
              <h3 className="text-[#1a1f4d] mb-3">Уведомления о мероприятиях</h3>
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              ...
              <h3 className="text-[#1a1f4d] mb-3">Доступ к документам</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              ...
              <h3 className="text-[#1a1f4d] mb-3">Нетворкинг</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-lg border border-gray-200">
              ...
              <h3 className="text-[#1a1f4d] mb-3">Личное расписание</h3>
              <p className="text-gray-600">
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-r from-[#1a1f4d] to-[#2c3570] text-white rounded-lg p-12 text-center">
            <h2 className="mb-4">Присоединяйтесь к мировому сообществу</h2>
            <p className="text-lg mb-8 opacity-90">
              Станьте частью глобального диалога и сотрудничества
            </p>
            <button
              className="px-8 py-3 bg-gradient-to-r from-[#4db8b8] to-[#7dd957] hover:opacity-90 text-white rounded-lg transition-opacity"
